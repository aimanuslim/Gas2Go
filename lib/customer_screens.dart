          ...
          child: Column(
            children: <Widget>[
              TextFormField(
                  ...
                  decoration:
                      InputDecoration(hintText: "Unit/House number, Building"),
                  validator: (value) {
                    if (value.isEmpty) {
              ...
              TextFormField(
                  ...
                  decoration: InputDecoration(hintText: "Road, Town"),
                  validator: (value) {
                    if (value.isEmpty) {
      ...
      child: Column(
        children: <Widget>[
          ...
          Padding(
            ...
            // italicise 'taukes'
            child: Text(
                "EZ Gas is a cooking gas ordering and delivery platform that connects the existing cooking gas suppliers and customers via the EZ Gas mobile application.\n\nOur mission is to improve the current services of the gas suppliers and to ensure convenience for customers in ordering cooking gas. We would also like to minimize the time it takes for a customer to receive their cooking gas from the point of order. With the EZ Gas mobile app, we hope to be the main platform in Malaysia to order cooking gas for both households as well as businesses.",
          ...
          Padding(
            ...
            child: RichText(
              ...
              TextSpan(
                  text:
                      "1. Place your order on our EZ Gas mobile app.\n\n2. Your order will then be broadcasted to nearby gas suppliers via the EZ Gas mobile app.\n\n3. Available suppliers will be able to view and accept your order via EZ Gas mobile app.\n\n4. You will be instantly notified via email when a driver has accepted your request and the supplier will contact you before making the delivery.",
          ...
          Padding(
            ...
            child: RichText(
                ...
                text: TextSpan(children: <TextSpan>[
                  ...
                  TextSpan(
                      text:
                          "EZ Gas allows you to order your gas on your fingertips. You do not have to call suppliers to order your gas anymore. Hence, you save on telephone bills!\n\n\n",
                      style:
                          TextStyle(fontSize: 15.0, color: Color(0xffCCCCCC))),
                  TextSpan(
                      text: "Extensive Network of Suppliers\n\n",
                      style: TextStyle(
                          fontSize: 16.0, fontWeight: FontWeight.w500)),
                  TextSpan(
                      text:
                          "We are privileged to be partnering with multiple gas suppliers around your area. In the event that a supplier cannot honour his delivery, your order will automatically be broadcasted to the next closest supplier. Therefore you do not have to worry about the gas delivery not arriving at your location anymore!\n\n\n",
                      style:
                          TextStyle(fontSize: 15.0, color: Color(0xffCCCCCC))),
                  TextSpan(
                      text: "Instant alerts with information\n\n",
                      style: TextStyle(
                          fontSize: 16.0, fontWeight: FontWeight.w500)),
                  TextSpan(
                      text:
                          "We will notify you via email the supplier’s information when they have accepted your order. Information on your gas delivery order such as supplier’s location, phone number and estimated fare will also be provided.",
                      style:
                          TextStyle(fontSize: 15.0, color: Color(0xffCCCCCC))),
                ])),
          ),
